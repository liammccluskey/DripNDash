...
class DasherJobInfoController: UIViewController {
    ...
    private func configureUI() {
        ...
        instructionsLabel = configureInfoLabel(keyLabel: "Customer Instructions", valueLabel: completedJob.customerInstructions)
