...
class CustomerRegisterController: UIViewController {
    ...
    @objc func registerAction() {
        ...
        let isValidRegistraion = customerFirestore.isValidRegistration(email: email, dorm: dorm, dormRoom: dormRoom, password: password, confirmPassword: confirmPassword)
